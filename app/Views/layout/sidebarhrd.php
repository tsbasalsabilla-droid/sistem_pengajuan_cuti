...
<body>
    ...
    <div class="sidebar" id="sidebarMenu">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="/hrd/kalender-cuti" class="nav-link-item <?= url_is('hrd/kalender-cuti*') ? 'active' : '' ?>">
            ...
            <a href="/hrd/cuti/index" class="nav-link-item <?= (url_is('hrd/cuti/index*') || url_is('hrd/cuti/detail*')) ? 'active' : '' ?>">
    ...
    <div class="main-content">
        <div class="d-lg-none d-flex align-items-center justify-content-between p-3 mb-3 bg-white border-bottom">
            <button class="menu-toggle" id="toggleBtn">
                <i class="ti ti-menu-2"></i>
            </button>
            <span class="fw-medium text-dark">HRD Panel</span>
