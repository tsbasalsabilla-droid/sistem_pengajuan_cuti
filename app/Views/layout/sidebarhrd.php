...
<head>
 ...
 <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="/pegawai" class="nav-link-item">
                <i class="ti ti-users"></i>
                <span>Data Pegawai</span>
            </a>
            <a href="/jabatan" class="nav-link-item">
                <i class="ti ti-building"></i>
                <span>Data Jabatan</span>
            </a>
            <a href="/divisi" class="nav-link-item">
                <i class="ti ti-sitemap"></i>
                <span>Data Divisi</span>
            </a>

            <div class="nav-section-title">Pengaturan Cuti</div>
            <a href="/cuti_bersama" class="nav-link-item">
                <i class="ti ti-calendar-check"></i>
                <span>Cuti Bersama</span>
            </a>

            <div class="nav-section-title">Laporan</div>
            <a href="/laporan" class="nav-link-item">
            ...
            <a href="/approvalhrd" class="nav-link-item">
                <i class="ti ti-file-analytics"></i>
                <span>Approval Cuti Karyawan</span>
            </a>
