...
<div class="sidebar">
    ...
    <a href="/spv/dashboard"
        class="<?= (str_contains($currentUrl, 'spv/dashboard') || $currentUrl == '/spv/dashboard') ? 'active' : ''; ?>">
        <i class="bi bi-speedometer2"></i>
        Dashboard
    </a>

    <a href="/spv/cuti/create"
        class="<?= (str_contains($currentUrl, 'spv/cuti/create') || $currentUrl == '/spv/cuti/create') ? 'active' : ''; ?>">
        <i class="bi bi-file-earmark-plus"></i>
        Pengajuan Cuti
    </a>

    <a href="/spv/cuti"
        class="<?= (str_contains($currentUrl, 'spv/cuti') && !str_contains($currentUrl, 'spv/cuti/create')) ? 'active' : ''; ?>">
