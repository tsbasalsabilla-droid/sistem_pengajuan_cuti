...
$routes->get('/hrd/cuti/history', 'CutiHrdController::history');
...
$routes->get('/approvalspv', 'ApprovalController::index');
$routes->get('/spv/dashboard', 'Spv::dashboard');
$routes->get('/spv', 'Spv::index');
$routes->get('/spv/approve/(:num)', 'Spv::approve/$1');
$routes->get('/approval/approve-spv/(:num)', 'ApprovalController::approveSpv/$1');
$routes->get('/spv/reject/(:num)', 'Spv::reject/$1');
$routes->get('/approval/reject-spv/(:num)', 'ApprovalController::rejectSpv/$1');
...
$routes->get('/approval/approve-hrd/(:num)', 'ApprovalController::approveHrd/$1');
...
$routes->get('/approvalhrd', 'ApprovalController::index');
